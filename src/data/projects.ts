...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline: "Production Dubai Brokerage Website",
    summary: "Ground-up rebuild of a RERA-certified Dubai brokerage's site, live on Cloudflare Workers.",
    category: "Full-Stack · Real Estate",
    description:
      "A ground-up rebuild of a real, operating Dubai property brokerage's public website (RERA-certified, trusted since 2005) — a Next.js 16 site with a real Firebase backend and a role-based admin dashboard the company uses to manage its own listings, agents, and content. Deployed to production on Cloudflare Workers. The design follows Apple's Liquid Glass language — translucent frosted surfaces, soft depth and light — in the company's own navy and gold. Every fact shown on the site traces back to the live site, the company's real Bayut portfolio, or is entered by the company through the admin dashboard.",
    tech: ["Next.js 16", "TypeScript", "Tailwind CSS v4", "Firebase", "Cloudflare Workers"],
    repo: "https://github.com/QossayKamel22/Meteorite-Real-estate",
    featured: true,
    image: "meteorite.jpg",
    imageAlt: "Meteorite Real Estate homepage and for-sale property listings",
    logo: "meteorite.png",
    hasVersionControl: true,
    gallery: [
      { src: "meteorite-forsale.jpg", alt: "Meteorite Real Estate for-sale property listings page" },
    ],
  },
  {
    slug: "panther",
    name: "PANTHER",
    tagline: "Personal AI Agent — \"Your Second Mind\"",
    summary: "A context-aware personal AI agent connecting calendar, email, tasks, and notes into one assistant.",
    category: "AI Agent Engineering",
    description:
      "A personal AI agent designed to go beyond a chatbot — understanding context across calendar, email, tasks, notes, documents, and conversations, then turning that context into proactive actions and insights. In active development, with a Next.js web app and a companion Flutter client (panther_app) in the same repository.",
    tech: ["Next.js", "TypeScript", "Flutter", "AI Agents"],
    repo: "https://github.com/QossayKamel22/Panther",
    featured: true,
    logo: "panther.png",
    hasVersionControl: true,
  },
  ...
  {
    slug: "modern-life-simulator",
    name: "Modern Life Simulator",
    tagline: "Web-Based Life Simulation Game",
    summary: "Browser life-sim where you build a career, manage finances, and buy property and cars.",
  ...
  {
    slug: "draggable-widget-dashboard",
    name: "Widget Dashboard",
    tagline: "Render-Isolated React Dashboard",
    summary: "Reorderable Clock and Note widget dashboard engineered around per-widget render isolation.",
    category: "Frontend · React Engineering",
    description:
      "A client-only React dashboard of reorderable Clock and Note widgets, persisted to localStorage with no backend. The defining constraint is render isolation — a Clock's per-second tick re-renders only that Clock, never its siblings — achieved by splitting layout, note text, and time into three independently owned state trees, documented with full architecture rationale and ADRs.",
